...
#[allow(non_camel_case_types)]
pub const ENUM_NAMES_DRIVE_ITEM_DATA: [&'static str; 3] = ["NONE", "FileItem", "Dir"];
...
impl<'a> DriveItem<'a> {
    ...
    pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
        DriveItem { _tab: table }
    }
    #[allow(unused_mut)]
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args DriveItemArgs<'args>,
    ) -> flatbuffers::WIPOffset<DriveItem<'bldr>> {
    ...
    pub const VT_MODIFIED_TIME: flatbuffers::VOffsetT = 10;

    #[inline]
    pub fn id(&self) -> Option<&'a str> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<&str>>(DriveItem::VT_ID, None)
    }
    #[inline]
    pub fn data_type(&self) -> DriveItemData {
        self._tab
            .get::<DriveItemData>(DriveItem::VT_DATA_TYPE, Some(DriveItemData::NONE))
            .unwrap()
    }
    #[inline]
    pub fn data(&self) -> Option<flatbuffers::Table<'a>> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(DriveItem::VT_DATA, None)
    }
    #[inline]
    pub fn modified_time(&self) -> u64 {
        self._tab
            .get::<u64>(DriveItem::VT_MODIFIED_TIME, Some(0))
            .unwrap()
    }
    #[inline]
...
impl<'a: 'b, 'b> DriveItemBuilder<'a, 'b> {
    ...
    pub fn add_id(&mut self, id: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(DriveItem::VT_ID, id);
    }
    #[inline]
    pub fn add_data_type(&mut self, data_type: DriveItemData) {
        self.fbb_.push_slot::<DriveItemData>(
            DriveItem::VT_DATA_TYPE,
            data_type,
            DriveItemData::NONE,
        );
    }
    ...
    pub fn add_data(&mut self, data: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(DriveItem::VT_DATA, data);
    }
    #[inline]
    pub fn add_modified_time(&mut self, modified_time: u64) {
        self.fbb_
            .push_slot::<u64>(DriveItem::VT_MODIFIED_TIME, modified_time, 0);
    }
    #[inline]
...
impl<'a> FileItem<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args FileItemArgs<'args>,
    ) -> flatbuffers::WIPOffset<FileItem<'bldr>> {
    ...
    pub const VT_FILE_NAME: flatbuffers::VOffsetT = 4;
    pub const VT_MD5: flatbuffers::VOffsetT = 6;
    pub const VT_SIZE_: flatbuffers::VOffsetT = 8;

    #[inline]
    pub fn file_name(&self) -> Option<&'a str> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<&str>>(FileItem::VT_FILE_NAME, None)
    }
    #[inline]
...
impl<'a: 'b, 'b> FileItemBuilder<'a, 'b> {
    ...
    pub fn add_file_name(&mut self, file_name: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(FileItem::VT_FILE_NAME, file_name);
    }
    #[inline]
    pub fn add_md5(&mut self, md5: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(FileItem::VT_MD5, md5);
    }
    #[inline]
...
pub struct DirArgs<'a> {
    pub items: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DirItem<'a>>>>,
    >,
}
...
impl<'a> DirItem<'a> {
    ...
    pub fn is_dir(&self) -> bool {
        self._tab
            .get::<bool>(DirItem::VT_IS_DIR, Some(false))
            .unwrap()
    }
}
...
impl<'a: 'b, 'b> DirItemBuilder<'a, 'b> {
    ...
    pub fn add_is_dir(&mut self, is_dir: bool) {
        self.fbb_
            .push_slot::<bool>(DirItem::VT_IS_DIR, is_dir, false);
    }
    #[inline]
...
impl<'a> InodeNode<'a> {
    #[inline]
    pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
        InodeNode { _tab: table }
    }
    #[allow(unused_mut)]
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args InodeNodeArgs<'args>,
    ) -> flatbuffers::WIPOffset<InodeNode<'bldr>> {
    ...
    pub fn item(&self) -> Option<DriveItem<'a>> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<DriveItem<'a>>>(InodeNode::VT_ITEM, None)
    }
}
...
impl<'a: 'b, 'b> InodeNodeBuilder<'a, 'b> {
    ...
    pub fn add_item(&mut self, item: flatbuffers::WIPOffset<DriveItem<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<DriveItem>>(InodeNode::VT_ITEM, item);
    }
    #[inline]
...
impl<'a> ReverseAccessNode<'a> {
    #[inline]
    pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
        ReverseAccessNode { _tab: table }
    }
    #[allow(unused_mut)]
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args ReverseAccessNodeArgs<'args>,
    ) -> flatbuffers::WIPOffset<ReverseAccessNode<'bldr>> {
        let mut builder = ReverseAccessNodeBuilder::new(_fbb);
        builder.add_inode(args.inode);
        if let Some(x) = args.parent_inodes {
            builder.add_parent_inodes(x);
        }
        builder.finish()
    }
    ...
    pub fn inode(&self) -> u64 {
        self._tab
            .get::<u64>(ReverseAccessNode::VT_INODE, Some(0))
            .unwrap()
    }
    #[inline]
    pub fn parent_inodes(&self) -> Option<flatbuffers::Vector<'a, u64>> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u64>>>(
                ReverseAccessNode::VT_PARENT_INODES,
                None,
            )
    }
}
...
impl<'a: 'b, 'b> ReverseAccessNodeBuilder<'a, 'b> {
    ...
    pub fn add_inode(&mut self, inode: u64) {
        self.fbb_
            .push_slot::<u64>(ReverseAccessNode::VT_INODE, inode, 0);
    }
    #[inline]
    pub fn add_parent_inodes(
        &mut self,
        parent_inodes: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u64>>,
    ) {
...
impl<'a> ScanState<'a> {
    #[inline]
    pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
        ScanState { _tab: table }
    }
    #[allow(unused_mut)]
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args ScanStateArgs<'args>,
    ) -> flatbuffers::WIPOffset<ScanState<'bldr>> {
        let mut builder = ScanStateBuilder::new(_fbb);
        builder.add_last_modified_date(args.last_modified_date);
        if let Some(x) = args.last_page_token {
            builder.add_last_page_token(x);
        }
        builder.finish()
    }
    ...
    pub fn last_page_token(&self) -> Option<&'a str> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<&str>>(ScanState::VT_LAST_PAGE_TOKEN, None)
    }
    #[inline]
    pub fn last_modified_date(&self) -> u64 {
        self._tab
            .get::<u64>(ScanState::VT_LAST_MODIFIED_DATE, Some(0))
            .unwrap()
    }
}
...
impl<'a: 'b, 'b> ScanStateBuilder<'a, 'b> {
    ...
    pub fn add_last_modified_date(&mut self, last_modified_date: u64) {
        self.fbb_
            .push_slot::<u64>(ScanState::VT_LAST_MODIFIED_DATE, last_modified_date, 0);
    }
    #[inline]
